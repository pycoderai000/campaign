  ...
  if (campaigns.length === 0) {
    return (
      <div className="bg-white/80 backdrop-blur-sm p-16 rounded-2xl shadow-soft text-center border border-gray-200">
        ...
        <p className="text-gray-600 text-lg font-semibold mb-2">No campaigns available</p>
        <p className="text-gray-400 text-sm">Create campaigns to view metrics</p>
      </div>
    );
  }
    ...
    <div className="space-y-6">
      <div className="bg-white/80 backdrop-blur-sm p-8 rounded-2xl shadow-soft border border-gray-200">
        ...
        {chartData.length > 0 ? (
          ...
          <div className="h-80 flex items-center justify-center bg-gradient-to-br from-gray-50 to-white rounded-2xl border border-gray-200">
